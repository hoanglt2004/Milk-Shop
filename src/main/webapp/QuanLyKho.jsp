...
<head>
    ...
    <title>Quản Lý Kho</title>
                    ...
                    <link href="${pageContext.request.contextPath}/css/admin-simple.css?v=${cssVersion}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                    <button class="btn btn-warning btn-action"
                                                                        onclick="editWarehouse('${e.warehouseID}', '${e.productID}', '${e.quantity}', '${importDateFormatted}', '${e.remainingQuantity}')">
    ...
    <!-- Modal thêm kho mới -->
                    <div id="addWarehouseModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="quanLyKho" method="POST">
                    ...
                    <!-- Modal sửa kho -->
                    <div id="editWarehouseModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="quanLyKho" method="POST">
                    ...
                    <!-- Modal xóa kho -->
                    <div id="deleteWarehouseModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="quanLyKho" method="POST">
    ...
    <script>
                    ...
                    <!-- Thêm Bootstrap JS và jQuery cuối trang -->
